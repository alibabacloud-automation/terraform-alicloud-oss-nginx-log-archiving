...
English | [简体中文](https://github.com/alibabacloud-automation/terraform-alicloud-oss-nginx-log-archiving/blob/main/README-CN.md)

Terraform module which creates a complete application log data archiving solution on Alibaba Cloud. This module implements the [Archive App Logs](https://www.aliyun.com/solution/tech-solution/oss-nginx) solution, involving the creation and deployment of resources such as Virtual Private Cloud (VPC), VSwitch, Elastic Compute Service (ECS), Simple Log Service (SLS) projects, and Object Storage Service (OSS) buckets for automated log collection, processing, and archiving.

## Usage

This module sets up a comprehensive log archiving infrastructure including nginx log generation, collection via SLS logtail, and automatic archiving to OSS storage.
...
* [Complete Example](https://github.com/alibabacloud-automation/terraform-alicloud-oss-nginx-log-archiving/tree/main/examples/complete)
